...
export const metadata: Metadata = {
  ...
  description: 'Условия использования платформы Велес Вояж. Регулирование отношений при использовании услуг и подключении кошельков. Ответственность сторон и правила оплаты.',
};
